     ...
     <HomeLayout>
        <div className=" flex items-center justify-center h-[90vh] md:h-[100vh]">
            <form
                ...
                <button type="submit" className=" w-full bg-cyan-800 hover:bg-yellow-500 transition-all ease-in-out duration-300 rounded-sm py-2 font-semibold text-lg cursor-pointer">Submit</button>
            </form>
        </div>
     </HomeLayout>
    )
