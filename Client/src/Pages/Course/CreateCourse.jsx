        ...
        <HomeLayout>
             <div className="flex items-center justify-center h-[100vh]">
                ...
                >
                    ...
                    <button type="submit" className="w-full bg-black text-lg hover:bg-white hover:text-black border rounded-s transition-all duration-300 ease-in-out py-2 rounded-sm font-semibold">
                        Create Course
                    </button>
