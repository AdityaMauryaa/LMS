            ...
            <div className="pt-10 text-white flex flex-col md:flex-row items-center justify-center mx-5 gap-10 lg:mx-16 h-[50rem] sm:h-[90vh]">
                ...
                <div className="mt-16 sm:mt-0 flex flex-col justify-center space-y-6">
                    ...
                    <p className="text-lg sm:text-xl text-gray-200">
                        Elite instructors. Proven content. No fluff.
                        Just the exact skills you need — when you need them.
                    </p>
                    ...
                    <div className="mt-6 text-sm sm:text-base text-gray-300">
                      <p className="mb-1">✨ Not sure what to learn next?</p>
                      <p className="mb-1">
                        Let&nbsp;
                        <a
                        ...
                        &nbsp;— our AI-powered learning assistant — guide you. It’s smart, fast, and completely free.
                      </p>
                    </div>
                </div>
